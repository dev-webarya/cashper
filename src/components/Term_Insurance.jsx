    ...
    switch(step) {
      case 1:
        ...
        if (!formData.age || formData.age < 18 || formData.age > 65) {
          alert('Please enter a valid age (18-65 years)');
          return false;
        }
        if (!formData.gender) {
      ...
      case 2:
        if (!formData.coverage) {
          alert('Please select life cover amount');
          return false;
        }
      ...
      case 4:
        ...
        for (const doc of requiredDocs) {
          if (!documents[doc]) {
            alert(`Please upload ${doc === 'aadhar' ? 'Aadhar Card' : doc === 'pan' ? 'PAN Card' : 'Passport Size Photo'}`);
            return false;
          }
        }
        return true;
              ...
              {currentStep === 5 && (
                <div className="text-center py-12 animate-fadeInUp">
                  ...
                  <div className="flex gap-4 justify-center">
                    <button
                      onClick={() => navigate('/')}
                      className="bg-green-600 text-white hover:bg-blue-700 font-bold px-8 py-4 rounded-full shadow-xl transition-all duration-300 inline-flex items-center justify-center gap-2"
                    >
