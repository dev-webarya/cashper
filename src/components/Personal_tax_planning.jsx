...
const Personal_tax_planning = () => {
  ...
  const handleSubmit = (e) => {
    ...
    alert('Thank you! Our tax planning expert will contact you soon.');
  };
  ...
  const calculateTaxSavings = () => {
    const { grossIncome, section80C, section80D, nps80CCD1B, homeLoanInterest } = taxCalculator;
