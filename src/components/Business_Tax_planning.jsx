...
const Business_Tax_planning = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Business Tax Form submitted:', formData);
    alert('Thank you! Our business tax expert will contact you within 24 hours.');
  };
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 xs:gap-6 sm:gap-7 md:gap-8 lg:gap-10 items-center">
            ...
            <div id="business-contact-form" className="bg-white rounded-lg xs:rounded-xl shadow-2xl p-3 xs:p-4 sm:p-5 md:p-6 mt-5 xs:mt-6 md:mt-0 mx-2 xs:mx-0">
              ...
              <form onSubmit={handleSubmit} className="space-y-2 xs:space-y-2.5 sm:space-y-3">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-green-600 to-green-700 text-white px-4 py-2.5 rounded-lg font-semibold hover:from-green-700 hover:to-green-800 transition-all duration-300 shadow-lg text-sm transform hover:scale-105"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 max-w-6xl mx-auto">
            <div className="bg-white rounded-xl p-5 sm:p-6 md:p-8 shadow-xl">
              ...
              <div className="space-y-4 sm:space-y-5">
                <div>
                  ...
                  <select className="w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-300 rounded-lg focus:border-green-700 focus:ring-2 focus:ring-green-200 outline-none text-sm sm:text-base">
                ...
                <button 
                  onClick={() => {
                    alert('For accurate business tax calculations tailored to your specific situation, please fill out the application form below or contact our tax experts directly.');
                    document.getElementById('business-contact-form').scrollIntoView({ behavior: 'smooth' });
                  }}
                  className="w-full bg-gradient-to-r from-green-700 to-green-800 text-white py-3 sm:py-4 rounded-lg font-semibold hover:from-green-800 hover:to-green-900 transition-all duration-300 shadow-lg text-sm sm:text-base">
            ...
            <div className="bg-gradient-to-br from-green-100 to-blue-100 rounded-xl p-5 sm:p-6 md:p-8 shadow-xl border-2 border-green-300">
              ...
              <div className="space-y-3 sm:space-y-4 mb-6">
                ...
                <div className="bg-gradient-to-r from-red-50 to-orange-50 rounded-lg p-3 sm:p-4 shadow border-2 border-red-300">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-base sm:text-lg font-bold text-red-600">₹0</span>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-r from-green-700 to-green-800 rounded-lg p-5 sm:p-6 text-center text-white shadow-xl">
                ...
                <p className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2">₹0</p>
      ...
      <section className="py-10 sm:py-12 md:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-10">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">
              Explore Our Other Business Services
            </h2>
            <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto">
