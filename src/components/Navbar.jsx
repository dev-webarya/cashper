...
const Navbar = () => {
  ...
  return (
    <nav className="w-full shadow-xl border-b-2 border-blue-100 py-1.5 xs:py-2 sm:py-2.5 md:py-3 lg:py-3 xl:py-3 fixed top-0 z-[9999] bg-white">
      <div className="w-full max-w-[1920px] mx-auto px-2 xs:px-3 sm:px-4 md:px-6 lg:px-8 xl:px-10">
        <div className="flex justify-between items-center h-12 xs:h-13 sm:h-14 md:h-16 lg:h-16 xl:h-18">
          ...
          <Link to="/" onClick={handleLogoClick} className="flex items-center group flex-shrink-0 cursor-pointer">
            <img
              ...
              alt="Cashper Logo"
              className="h-7 xs:h-8 sm:h-10 md:h-12 lg:h-14 xl:h-16 w-auto group-hover:scale-105 transition-all duration-300"
            />
          </Link>

          {/* Desktop Navigation */}
          <div className="hidden lg:flex items-center space-x-0 lg:space-x-0.5 xl:space-x-1">
              ...
              >
                {item.dropdown ? (
                  <div className="relative z-50">
                    <button
                      className={`px-2 py-1.5 lg:px-2.5 lg:py-2 xl:px-3 xl:py-2 text-xs lg:text-sm xl:text-base text-gray-700 hover:text-blue-600 font-semibold transition-all duration-300 rounded-lg hover:bg-gradient-to-r hover:from-green-500 hover:to-indigo-100 relative group flex items-center gap-0.5 lg:gap-1 ${
                  ...
                  <button
                    ...
                    className={`px-2 py-1.5 lg:px-2.5 lg:py-2 xl:px-3 xl:py-2 text-xs lg:text-sm xl:text-base text-gray-700 hover:text-blue-600 font-semibold transition-all duration-300 rounded-lg hover:bg-gradient-to-r hover:from-green-500 hover:to-indigo-100 relative group bg-transparent border-0 cursor-pointer ${
          ...
          {/* Desktop CTA Buttons */}
          <div className="hidden lg:flex items-center space-x-1 lg:space-x-1.5 xl:space-x-2 flex-shrink-0">
            <button
              onClick={handleApplyNow}
              className="bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 active:from-green-800 active:to-green-900 text-white px-2.5 py-1.5 lg:px-3 lg:py-1.5 xl:px-4 xl:py-2 rounded-lg lg:rounded-xl font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 active:scale-95 text-xs lg:text-sm xl:text-base cursor-pointer whitespace-nowrap"
            >
              Apply Now
            </button>
            <button
